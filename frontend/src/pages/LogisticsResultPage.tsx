...
export default function ResultPage() {
  ...
  useEffect(() => {
    ...
    api.get(`/logistics/analyses/${id}`).then((res) => {
      setAnalysis(res.data);
    });

    api.get(`/logistics/analyses/${id}/ai`).then((res) => {
  ...
  writeText("Industry: Logistics", 0, 12);
  ...
  doc.save(`Logistics_Report_${id}.pdf`);
};


  /* ================= UI ================= */

  if (!analysis) return <p>Loading logistics analysis...</p>;
  ...
  return (
    <div style={{ padding: "24px" }}>
      ...
      >
        <h2>Logistics Financial Summary</h2>
