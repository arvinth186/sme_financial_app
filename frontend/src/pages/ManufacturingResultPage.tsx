...
export default function ManufacturingResultPage() {
  ...
  useEffect(() => {
    ...
    api.get(`/manufacturing/analyses/${id}`).then((res) => {
      setAnalysis(res.data);
    });

    api.get(`/manufacturing/analyses/${id}/ai`).then((res) => {
  ...
  writeText("Industry: Manufacturing", 0, 12);
  ...
  doc.save(`Manufacturing_Report_${id}.pdf`);
};


  /* ================= UI ================= */

  if (!analysis) return <p>Loading manufacturing analysis...</p>;
  ...
  return (
    <div style={{ padding: "24px" }}>
      ...
      >
        <h2>Manufacturing Financial Summary</h2>
