...
export default function RetailResultPage() {
  ...
  useEffect(() => {
    ...
    api.get(`/retail/analyses/${id}`).then((res) => {
      setAnalysis(res.data);
    });

    api.get(`/retail/analyses/${id}/ai`).then((res) => {
  ...
  writeText("Industry: Retail", 0, 12);
  ...
  doc.save(`Retail_Report_${id}.pdf`);
};


  /* ================= UI ================= */

  if (!analysis) return <p>Loading retail analysis...</p>;
  ...
  return (
    <div style={{ padding: "24px" }}>
      ...
      >
        <h2>Retail Financial Summary</h2>
