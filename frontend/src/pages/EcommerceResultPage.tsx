...
export default function ResultPage() {
  ...
  useEffect(() => {
    ...
    api.get(`/ecommerce/analyses/${id}`).then((res) => {
      setAnalysis(res.data);
    });

    api.get(`/ecommerce/analyses/${id}/ai`).then((res) => {
  ...
  writeText("Industry: Ecommerce", 0, 12);
  ...
  doc.save(`Ecommerce_Report_${id}.pdf`);
};


  /* ================= UI ================= */

  if (!analysis) return <p>Loading ecommerce analysis...</p>;
  ...
  return (
    <div style={{ padding: "24px" }}>
      ...
      >
        <h2>Ecommerce Financial Summary</h2>
